classdef (StrictDefaults)PitchShifter < audioPlugin & matlab.System
    ...
    % example
    %
    % See also: audiopluginexample.SpeechPitchDetector
    ...
    properties (Constant, Hidden)
        ...
        PluginInterface = audioPluginInterface( ...
            audioPluginParameter("PitchShift", DisplayName="Pitch Shift", ...
                Label="semitones", DisplayNameLocation="above", ...
                Mapping={"int",-12,12}, Style="rotaryknob", Layout=[2 1]), ...
            audioPluginParameter("Overlap", DisplayName="Overlap", ...
                DisplayNameLocation="above", Mapping={"lin",.01,.5}, ...
                Style="rotaryknob", Layout=[2 2]), ...
            audioPluginGridLayout(RowHeight=[20 100], ...
    ...
    methods (Access = protected)
        ...
        function s = saveObjectImpl(obj)
            ...
            if isLocked(obj)
                s.pShifter = matlab.System.saveObject(obj.pShifter);
                s.pRate = obj.pRate;
                s.pSampsDelay = obj.pSampsDelay;
                s.pPhaseStep = obj.pPhaseStep;
                s.pFaderGain = obj.pFaderGain;
            end
        end

        function loadObjectImpl(obj, s, wasLocked)
            if wasLocked
                obj.pShifter = matlab.System.loadObject(s.pShifter);
                obj.pRate = s.pRate;
                obj.pSampsDelay = s.pSampsDelay;
                obj.pPhaseStep = s.pPhaseStep;
                obj.pFaderGain = s.pFaderGain;
            end
